...
/*Aqui, o main tem como objetivo pedir ao usuário o número k
de divisões e chamar a primeira função para dar prosseguimento 
ao programa */
int main(void){
	int k;
...
/*Essa função tem como objetivo calcular dois exemplares de
numeros (no caso, "a" e "b") onde o calculo de seu mdc realiza
exatamente k divisões.*/
void num_k_divisoes (int k){
...
/*Essa função serve como "prova", isto é, serve para realizar
o teste de mesa e comprovar que o mdc(a, b) realiza exatamente
as k divisões pedidas*/
void euclides (int dividendo, int divisor, int resto){
